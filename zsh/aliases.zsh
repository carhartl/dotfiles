...
alias todos="rg TODO: -uu -g '!*.git' -g '!venv'"
alias fixmes="rg FIXME: -uu -g '!*.git' -g '!venv'"
...
alias update="brew update; brew upgrade; brew cleanup; yarn global upgrade; gem update --system; gem update; pip install --upgrade pip"
