...
alias update="echo '\e[32m==>\e[0m Homebrew...'; brew update; brew upgrade; echo '\e[32m==>\e[0m rtx plugins...'; rtx plugins update --all; echo '\e[32m==>\e[0m Ruby...'; gem update --system; gem update; echo '\e[32m==>\e[0m Python...';  pip install --upgrade pip; echo '\e[32m==>\e[0m Nodejs...'; npm update --location=global npm; npm update --location=global; echo '\e[32m==>\e[0m Rust...'; rustup update"
